...
| CA09 | Ruta absoluta en cabecera | Verificar al navegar |
...
| CA14 | Scroll automático con ▲/▼ | Navegar en directorio grande |
...
| CA25 | Leyenda de teclas visible en la pantalla principal | Verificar línea de ayuda inferior |
...
- **8/26 listos para validación manual:** CA11 (ocultos), CA12 (symlinks), CA17 (permisos), CA22 (sin color), CA23 (separadores), CA24 (tamaños), CA25 (leyenda), CA26 (contenido completo derecha + contexto izquierda)
